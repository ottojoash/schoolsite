...
try {
    ...
    $flash_query = "SELECT * FROM flash_notice WHERE id = 2";
...
// Close the connection outside of the try-catch block
if ($connection) {
    ...
    <main>
        ...
        <section id="courses" class="text-gray-600 body-font">
            <div class="container px-5 py-24 mx-auto">
                <div class="text-center mb-10">
                    <h1 class="sm:text-3xl text-2xl font-medium text-center title-font text-blue-600 mb-4">Our Academics</h1>
                    <p class="text-justify text-sm md:text-base text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto">
                ...
                <div class="flex flex-wrap -mx-4 -mb-10 text-center">
                    <div class="sm:w-1/2 mb-10 px-4">
                        ...
                        <h2 class="title-font text-2xl font-medium text-gray-900 mt-6 mb-3">O' LEVEL</h2>
                        <p class="text-justify text-sm md:text-base leading-relaxed text-base">
                        <?php echo $row['fifteen'];?></p>
                        <button onclick="joinbtn()" class="flex mx-auto mt-6 text-white bg-indigo-500 border-0 py-2 px-5 focus:outline-none hover:bg-indigo-600 rounded">Join O' LEVEL</button>
                    </div>
                    <div class="sm:w-1/2 mb-10 px-4">
                        <div class="rounded-lg h-64 overflow-hidden">
                            <img alt="content" class="object-cover object-center h-full w-full" src="assects/images/courses/computerscience.jpg">
                        </div>
                        <h2 class="title-font text-2xl font-medium text-gray-900 mt-6 mb-3">A LEVEL</h2>
                        <p class="text-justify text-sm md:text-base leading-relaxed text-base">
                        <?php echo $row['sixteen'];?></p>
                        <button onclick="joinbtn()" class="flex mx-auto mt-6 text-white bg-indigo-500 border-0 py-2 px-5 focus:outline-none hover:bg-indigo-600 rounded">Join A LEVEL</button>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="flex flex-wrap -m-4">
                    ...
                    <div class="xl:w-1/4 md:w-1/2 p-4">
                        <div class="bg-gray-100 p-6 rounded-lg">
                            ...
                            <h3 class="tracking-widest text-indigo-500 text-xs font-medium title-font"></h3>
                            <h2 class="text-lg text-gray-900 font-medium title-font mb-4">Chemistry Lab</h2>

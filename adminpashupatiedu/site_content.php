...
// Close the database connection after the try-catch block
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Variables to get new site content
    ...
    // Contact Us PAGE variable
    $contactOne = $_POST['contactOne'];

    // Join Us PAGE variable
    ...
    // Binding parameters for each page
    ...
    // Executing and alerting success
...
<body>
    <?php include('../includes/admin_header.php') ?>
        ...
        <div id="accordion-collapse-body-1" class="hidden" aria-labelledby="accordion-collapse-heading-1">
            ...
            <p class="mb-2 font-bold text-gray-500 dark:text-gray-600">O LEVEL and A LEVEL</p>
        ...
        <div id="accordion-collapse-body-2" class="hidden" aria-labelledby="accordion-collapse-heading-2">
            <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                ...
                <p class="mb-2 font-bold text-gray-500 dark:text-gray-600">Our Courses - O LEVEL and A LEVEL</p>
                ...
                <p class="mb-2 font-bold text-gray-500 dark:text-gray-600">Our Academics - O LEVEL and A LEVEL</p>
                ...
                <p class="mb-2 font-bold text-gray-500 dark:text-gray-600">Our Facilities - Chemistry</p>

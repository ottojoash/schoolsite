...
try {
    ...
    $flash_query = "SELECT * FROM flash_notice WHERE id = 6";
                ...
                <div class="flex flex-wrap -m-2">
                    ...
                    <div class="p-2 lg:w-1/3 md:w-1/2 w-full" onclick="nepalicalender()">
                        <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg hover:bg-blue-100">
                            ...
                            <div class="flex-grow">
                                <h2 class="text-blue-600 title-font font-medium">School Calender</h2>
                    ...
                    <div class="p-2 lg:w-1/3 md:w-1/2 w-full" onclick="ePustakalaya()">
                        <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg hover:bg-blue-100">
                            ...
                            <div class="flex-grow">
                                <h2 class="text-blue-600 title-font font-medium">E-Koboko Town College </h2>
                    ...
                    <div class="p-2 lg:w-1/3 md:w-1/2 w-full" onclick="staffs()">
                        <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg hover:bg-blue-100">
                            ...
                            <div class="flex-grow">
                                ...
                                <p class="text-sm md:text-base text-gray-500">School Staff, Parents
